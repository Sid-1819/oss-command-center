import type { MarkdownDocPlanStep } from "./types";
...
function applyStep(content: string, step: MarkdownDocPlanStep): string {
...
export interface ApplyMarkdownDocPlanResult {
  updatedContent: string;
  appliedSteps: MarkdownDocPlanStep[];
  skippedSteps: MarkdownDocPlanStep[];
}

export function applyMarkdownDocPlan(
  content: string,
  steps: MarkdownDocPlanStep[],
): ApplyMarkdownDocPlanResult {
  let updatedContent = content;
  const appliedSteps: MarkdownDocPlanStep[] = [];
  const skippedSteps: MarkdownDocPlanStep[] = [];
...
export type ApplyReadmePlanResult = ApplyMarkdownDocPlanResult;
export const applyReadmePlan = applyMarkdownDocPlan;
